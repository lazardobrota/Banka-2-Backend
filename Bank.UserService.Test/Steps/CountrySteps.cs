...
public class CountrySteps(ScenarioContext scenarioContext, ICountryService countryService)
{
    ...
    {
        var name   = m_ScenarioContext.Get<CountryFilterQuery>(Constant.FilterParam).Name;
        var result = m_ScenarioContext.Get<Result<Page<CountryResponse>>>(Constant.GetResult);
        result.ActionResult.ShouldBeOfType<OkObjectResult>();
    ...
    {
        var code   = m_ScenarioContext.Get<CountryFilterQuery>(Constant.FilterParam).CurrencyCode;
        var result = m_ScenarioContext.Get<Result<Page<CountryResponse>>>(Constant.GetResult);
        result.ActionResult.ShouldBeOfType<OkObjectResult>();
        result.Value.ShouldNotBeNull();
    ...
    {
        var name   = m_ScenarioContext.Get<CountryFilterQuery>(Constant.FilterParam).CurrencyName;
        var result = m_ScenarioContext.Get<Result<Page<CountryResponse>>>(Constant.GetResult);
        result.ActionResult.ShouldBeOfType<OkObjectResult>();
        result.Value.ShouldNotBeNull();
        name.ShouldNotBeNull();
