...
internal static class StockOpenApiMapper
{
    public static OpenApiObject ToOpenApiObject(this StockResponse value)
    {
        return MapOpenApiObject(value, new OpenApiObject());
    }

    public static OpenApiObject MapOpenApiObject(this StockResponse value, OpenApiObject @object)
    {
        ...
        @object[nameof(value.Volume)
                .ToCamelCase()] = new OpenApiDouble(value.Volume);
    ...
    public static OpenApiObject ToOpenApiObject(this StockSimpleResponse value)
    {
        return MapOpenApiObject(value, new OpenApiObject());
    }

    public static OpenApiObject MapOpenApiObject(this StockSimpleResponse value, OpenApiObject @object)
    {
        @object[nameof(value.Id)
                .ToCamelCase()] = new OpenApiString(value.Id.ToString());
    ...
    public static OpenApiObject ToOpenApiObject(this StockDailyResponse value)
    {
        return MapOpenApiObject(value, new OpenApiObject());
    }

    public static OpenApiObject MapOpenApiObject(this StockDailyResponse value, OpenApiObject @object)
    {
        @object[nameof(value.Id)
                .ToCamelCase()] = new OpenApiString(value.Id.ToString());
