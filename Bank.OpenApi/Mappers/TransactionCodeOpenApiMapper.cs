...
internal static class TransactionCodeOpenApiMapper
{
    public static OpenApiObject ToOpenApiObject(this TransactionCodeResponse value)
    {
        return MapOpenApiObject(value, new OpenApiObject());
    }

    public static OpenApiObject MapOpenApiObject(this TransactionCodeResponse value, OpenApiObject @object)
    {
