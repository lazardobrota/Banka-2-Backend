...
internal static partial class Schema
{
    internal static partial class Swagger
    {
        ...
        {
            internal class Response(OpenApiSchemaContext openApiContext) : AbstractSwaggerSchema<OptionResponse>(openApiContext)
            {
            ...
            internal class SimpleResponse(OpenApiSchemaContext openApiContext) : AbstractSwaggerSchema<OptionSimpleResponse>(openApiContext)
            {
                protected override IOpenApiAny CreateExample()
                {
                    return Example.ToOpenApiObject();
            ...
            internal class DailyResponse(OpenApiSchemaContext openApiContext) : AbstractSwaggerSchema<OptionDailyResponse>(openApiContext)
            {
                protected override IOpenApiAny CreateExample()
                {
                    return Example.ToOpenApiObject()
