...
internal static partial class Schema
{
    internal static partial class Swagger
    {
        ...
        {
            internal class Response(OpenApiSchemaContext openApiContext) : AbstractSwaggerSchema<CountryResponse>(openApiContext)
            {
            ...
            internal class SimpleResponse(OpenApiSchemaContext openApiContext) : AbstractSwaggerSchema<CountrySimpleResponse>(openApiContext)
            {
                protected override IOpenApiAny CreateExample()
                {
                    return Example.ToOpenApiObject();
