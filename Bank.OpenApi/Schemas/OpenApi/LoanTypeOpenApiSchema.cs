...
internal static partial class Schema
{
    internal static partial class OpenApi
    {
        ...
        {
            internal class CreateRequest() : AbstractOpenApiSchema<LoanTypeCreateRequest>()
            {
            ...
            internal class UpdateRequest() : AbstractOpenApiSchema<LoanTypeUpdateRequest>()
            {
                public override void ApplyExample(OpenApiSchemaContext context)
                {
                    if (!TryGetExample(context, out var example))
            ...
            internal class Response() : AbstractOpenApiSchema<LoanTypeResponse>()
            {
                public override void ApplyExample(OpenApiSchemaContext context)
                {
                    if (!TryGetExample(context, out var example))
