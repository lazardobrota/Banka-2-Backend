...
using ForexPairModel = ForexPair;

public static partial class Seeder
{
    public static class ForexPair
    {
        public static readonly ForexPairModel UsdEur = new()
                                                       {
        ...
        public static readonly ForexPairModel UsdGbp = new()
                                                       {
        ...
        public static readonly ForexPairModel EurJpy = new()
                                                       {
        ...
        public static readonly ForexPairModel GbpAud = new()
                                                       {
...
public static class ForexPairSeederExtension
{
    ...
    {
        if (context.ForexPairs.Any())
            return;

        await context.ForexPairs.AddRangeAsync(Seeder.ForexPair.EurJpy, Seeder.ForexPair.GbpAud, Seeder.ForexPair.UsdEur, Seeder.ForexPair.UsdGbp);
