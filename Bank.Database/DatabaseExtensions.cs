...
{
    public static IServiceCollection AddDatabaseContext<TDatabaseContext>(this IServiceCollection services, Action<DbContextOptionsBuilder>? optionsAction = null)
